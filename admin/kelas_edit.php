    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-5">
                <?php
                    $id = @$_GET['id'];
                    $qrykoreksi=mysqli_query($koneksi,"select * from tb_kelas where id_kelas='$id'");
        ...
        if(@$_POST['edit']){
            ...
            $query=mysqli_query($koneksi,"UPDATE tb_kelas SET kelas='$kelas' WHERE id_kelas='$id'") or die (mysql_error());
            
            if($query){
                 echo '<script>window.location="kelas.php?page=kelas&&edit=edit-data"</script>';
              }else{
              ?>
