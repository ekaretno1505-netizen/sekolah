  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <?php 
            if(isset($_POST['input'])){
              ...
              $query=mysqli_query($koneksi,"insert into tb_mapel(kode_mapel, mapel) values('$kode_mapel', '$mapel')") or die (mysqli_error());
              
              if($query){
                echo '<script>window.location="mapel.php?page=mapel&&success=tambah-data"</script>';
              }else{
              ?>
        ...
        <div class="card-body">
            <?php
                $view=mysqli_query($koneksi,"select * from tb_mapel order by kode_mapel asc");
                $no=0;
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>   
                        ...
                        <td><i><a href="mapel_edit.php?page=mapel_edit&id=<?php echo $row['id_mapel'];?>"><i class=" fas fa-edit"> Edit</i></a> / <a onclick="return confirm('Yakin akan hapus data ini ?')" href="mapel_hapus.php?id=<?php echo $row['id_mapel'];?>"><i class="fas fa-trash"> Hapus</i></a></td>
                    </tr>
                    <?php
                        }
                    ?>
