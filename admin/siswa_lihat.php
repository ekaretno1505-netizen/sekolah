...
<div class="row">
    <div class="col-lg-12">
        <div class="tab-content">
            ...
            ?>
            <div class="tab-pane fade show active" id="<?php echo $row2['kelas']; ?>" role="tabpanel">
                <br>
                     ...
                     <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="siswa_edit.php?page=editsiswa&id=<?php echo $row3['id_siswa'];?>"><i class=" fas fa-edit"> Edit</i></a> / <a onclick="return confirm('Yakin akan hapus data ini ?')" href="siswa_hapus.php?id=<?php echo $row3['id_siswa'];?>"><i class="fas fa-trash"> Hapus</i></a></td>
                            </tr>
                            <?php
                                }
                            ?>
