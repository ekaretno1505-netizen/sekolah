          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-5">
                <?php
                    $kode = @$_GET['id'];
                    $qrykoreksi=mysqli_query($koneksi,"select * from tb_mapel where id_mapel='$kode'") or die (mysql_error());
                ...
                <form method="post">
                  ...
                  <?php
                    if(@$_POST['edit']){
                        ...
                        $query=mysqli_query($koneksi,"update tb_mapel set kode_mapel='$kode_mapel', mapel='$mapel' where id_mapel='$kode'") or die (mysqli_error());
                        
                        if($query){
                           echo '<script>window.location="mapel.php?page=mapel&&edit=edit-data"</script>';
                        }else{
                            ?>
