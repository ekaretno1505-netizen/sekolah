      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Set Mata Pelajaran</h3>
          ...
          if(isset($_POST['input'])){
              ...
              $query=mysqli_query($koneksi,"insert into tb_mengajar(kode_guru, kode_mapel) values('$kode_guru','$kode_mapel')") or die (mysqli_error());
              
              if($query){
                echo '<script>window.location="guru_mapel.php?page=gurumapel&&success=tambah-data"</script>';
              }else{
              ?>
        ...
        <div class="card-body">
           <?php
                $view=mysqli_query($koneksi, "SELECT tb_guru.nama_guru, tb_mengajar.id_mengajar, tb_mapel.mapel from tb_guru, tb_mengajar, tb_mapel 
