    ...
    <section class="content">
      <div class="container-fluid">
                ...
                <div class="col-lg-7">
                  ...
                  <div class="form-group">
                      ...
                      <select name="id_mengajar" class="form-control" required>
                          ...
                          <?php 
                              $query=mysqli_query($koneksi,"SELECT tb_guru.nama_guru, tb_mengajar.id_mengajar, tb_mapel.mapel 
        ...
        if(isset($_POST['input'])){
            ...
            $query=mysqli_query($koneksi,"insert into tb_jadwal(id_mengajar, hari, jam_mulai, jam_berakhir, id_kelas) 
                                values('$id_mengajar','$hari', '$jam_mulai', '$jam_berakhir',  '$kelas')") 
                                or die (mysqli_error());
            
            if($query){
              echo '<script>window.location="jadwal_lihat.php?page=jadwal&&success=tambah-data"</script>';
            }else{
            ?>
                <script type="text/javascript">
                alert("Input Data Gagal !")
                window.location="jadwal_lihat.php?page=lihatjadwal";
                </script>
            <?php
            } 
        }
