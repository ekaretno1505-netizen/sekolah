          ...
          <div class="col-sm-6">
            <?php if(isset($_GET['login'])){?>
                            <div class="alert alert-success" role="alert" >
                                <strong>Selamat Datang <?php echo $_SESSION['username']; ?> !</strong> Selamat Melakukan Pekerjaan
                            </div>
                      <?php }?>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="guru_lihat.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
